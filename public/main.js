$(window).scroll(function(){
  ...
  // var st3 = $(this).scrollTop();
  // if (st3 <= 500){
  //     $(".head-parallax-wrapper").css({
  //       "height" :  + jumboHeight-(st3/400),
  //       "color" :"red"
  //     });
  // } else {
  //   $(".head-parallax-wrapper").css({
  //     "height" : + jumboHeight+(st3/100),
  //     "color" :"green"
  //   });
  // }
  //
  // console.log(st3, "наша st3");
  // console.log(st3/100, "наша st3");
  // $(".head-parallax-wrapper").css({
  //   // "transform" : "translate3d(0px,  - " + st3/6  + "%, .01px)",
	// 	// "-webkit-transform" : "translate3d(0px,  -"  + st3/6  + "%, .01px)",
  //
  //     "height" :  + jumboHeight-(st3/100),
  //     "color" :"red"
  //   });
  ...
  // console.log(jumboHeight-(st3/100), "состояние высоты wrapper");
...
//     $('.head-parallax-wrapper').css('height', (jumboHeight-scrolled) + 'px');
//     console.log(jumboHeight-scrolled, "после Высота");
// }
//
